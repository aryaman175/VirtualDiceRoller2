...
$(document).ready(function() {
  ...
  myList.style.top = y +a/4 - 22 +"px";   // aligning with boxes

  listButton.style.left = 3*x + 50 + "px"; // 50 pixels left of 3rd guy
  listButton.style.top = y - 20 +"px";  // just above list

  // // WARNING: position
   // warning.style.position = "absolute";
   // warning.style.top = y - 100 + "px";
   // warning.style.left = 2*x + "px";
...
links[6].push(n1,n2,n3,n4,n5,n6)
var c6 = new p5(sketch)
c6.heading = "Numbers";

//CANAVAS 8
links[7].push(d1,d2,d3,d4,d5,d6)
var c7 = new p5(sketch)
c7.heading = "Dots";

links[8].push(ten1,ten2,ten3,ten4,ten5,ten6)
var c8 = new p5(sketch)
c8.heading = "10-60";

links[9].push(ten7,ten8,ten9,ten7,ten8,ten9)
var c9 = new p5(sketch)
c9.heading = "70-90";
